    ...
    <div class="row">
        <div class="col-md-12">
              ...
              <div class="well">
                ...
                <form action="{{route('new-blog')}}" method="POST" class="form-horizontal mt-2" enctype="multipart/form-data">
                  @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <textarea name="blog_short_desc" class="form-control"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea name="blog_long_desc" class="form-control"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Blog Title</label>
